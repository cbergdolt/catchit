<?php //jobdata/newinterview.php; collects data to put in new interview tuple
session_start();
$userid = $_SESSION['id'];
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="inputLocation" name="location">
                        ...
                        <div class="form-group">
                        	...
                        	<textarea type="text" rows="6" class="form-control" id="inputNotes" name="notes"></textarea>
                        </div>
			<input type="hidden" name="jobid" value="<?php echo $jobid?>">
			<input type="hidden" name="intid" value="0">
